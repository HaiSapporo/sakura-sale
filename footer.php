...
<?php // Incrementing counts value
	$plus_counter = $counter+1;
	$statement = $pdo->prepare("UPDATE tbl_settings SET visitor_counter=?");
	$statement->execute(array($plus_counter));
?>
...
<div class="footer-bottom">
	<div class="container">
		...
		<div class="row">
		<div class="col-md-12 copyright">
			Số lượng truy cập: <?php echo $counter; ?>
			</div>
			</div>
	</div>
</div>
