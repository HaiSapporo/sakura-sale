...
if (isset($_POST['form1'])) {
	...
	if ($valid == 1) {
		...
		while (!feof($file)) {
			...
			//$accessToken = '02ddf46a8bf47c9b624e78e8ddb8f39d8e7952b4';
   			//$data = array(
        		//	'long_url' => $row_of_file['12']. "/?tag=" . $tag
   			 //);
 ...
 //   return false;
			//$short_url = echo "$responseData['link']";
			...
			if($rowCheck) { // if data exist update the data
				...
				$statement->execute(
					array(
						...
						1,
						$insert_category,
						strip_tags($_POST['search_keyword'],'<p><a>'),
						$row_of_file[3]
					));
			} else {
				$statement = $pdo->prepare(
			...
			$success_message = "Các sản phẩm đã được đăng ký vào  " .$_POST['tcat_id']. "";
		}
	}
}
?>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Keyword Search</label>
							<div class="col-sm-8">
								<textarea name="search_keyword" class="form-control" cols="10" rows="4"
									id="editor1"></textarea>
							</div>
						</div>
