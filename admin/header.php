	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?php dirname(__FILE__)?>/4649blog_vps/index.php" class="logo" target="_blank">
				<span class="logo-lg">4649.blog | Admin</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($cur_page == 'product-import.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="product-import.php">
                            <i class="fa fa-hand-o-right"></i> <span>Import Product</span>
                        </a>
                    </li>

					<li class="treeview <?php if($cur_page == 'product-display.php') {echo 'active';} ?>">
                        <a href="product-display.php">
                            <i class="fa fa-hand-o-right"></i> <span>View sản phẩm frontend</span>
                        </a>
                    </li>
					...
					<li class="treeview">
                        <a href="post-facebook.php">
                            <i class="fa fa-hand-o-right"></i> <span>Post bài facebook</span>
                        </a>
                    </li>

					<li class="treeview">
                        <a href="post-blogspot.php">
                            <i class="fa fa-hand-o-right"></i> <span>Post bài blog HTML</span>
                        </a>
                    </li>

					<li class="treeview">
                        <a href="rutgonlink.php">
                            <i class="fa fa-hand-o-right"></i> <span>Rút gọn link</span>
                        </a>
                    </li>
