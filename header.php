...
<head>
	...
	<link rel="stylesheet" href="assets/css/main.css?ver=1.7">
	<link rel="stylesheet" href="assets/css/responsive.css">
	<link rel="stylesheet" href="assets/css/animation_card.css">
	<?php
	...
	<div class="header">
		<div class="container">
			<div class="row inner">
				...
				<a href="<?php echo $home;?>index.php" class="text-decoration-none">
						<h1 class="m-0 display-5 font-weight-semi-bold"><span
								class="text-primary font-weight-bold border px-3 mr-1">4649.blog</span></h1>
					</a>
				</div>
			...
			<div class="row">
				<div class="col-md-12 pl_0 pr_0">
					<div class="menu-container">
						<div class="menu">
							<ul>
								<li><a href="<?php echo $home;?>index.php">Home</a></li>
								<?php
								$statement = $pdo->prepare("SELECT * FROM tbl_top_category WHERE show_on_menu=1");
								$statement->execute();
								$result = $statement->fetchAll(PDO::FETCH_ASSOC);
								foreach ($result as $row) { ?>
									<?php $statement1 = $pdo->prepare("SELECT * FROM tbl_mid_category WHERE tcat_id=?");
									$statement1->execute(array($row['tcat_id']));
									$check_exist_mid = $statement1->rowCount();
									if ($check_exist_mid > 0) { ?>
