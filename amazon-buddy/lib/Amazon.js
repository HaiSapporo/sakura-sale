...
class AmazonScraper {
            ...
            forEachLimit(
                ...
                async (item) => {
                    ...
                    if (this.scrapeType === 'products') {
                        ...
                        // duyet toan bo product theo keyword
    ...
    get fileName() {
        switch (this.scrapeType) {
            ...
            case 'reviews':
            case 'asin':
                return `${this.scrapeType}_(${this.asin})_${this.initTime}`;
            default:
    ...
    grabProduct(body, p) {
        ...
        for (let key in scrapingResult) {
            try {
                ...
                //hai.phan_edit
                const titleThumbnailSearch = $(`div[data-asin=${key}] img[data-image-source-density="1"]`)[0];
                ...
                if (priceSearch) {
                    ...
                    //console.log(scrapingResult[key].title);
